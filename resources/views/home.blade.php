                    ...
                    <div class="row align-items-md-stretch mt-4">
                        ...
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                ...
                                <p class="text-end">with <i class="bi bi-lightning"></i> <a href="https://github.com/changeweb/Unifiedtransform" target="_blank" style="text-decoration: none;">Insigh Ed</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
